...
# import gc
# gdf = gpd.read_file("pages/soi_osm_sheet_index.geojson.json" )
...
# def main():
#     st.title("(EXPERIMENTAL) AI Georeferencer")
#     st.subheader('Made by Jason Dsouza')
#     st.text('Currently works on 1:50,000 scale Survey of India maps.')
#     st.markdown(
#     r"""
#     <style>
#     .stDeployButton {
